...
class Category(models.Model):
    ...
    parent_category = models.ForeignKey(
        ParentCategory, null=True, blank=True, on_delete=models.CASCADE
    )
...
class Pricing(models.Model):
    product = models.ForeignKey(
        Products, related_name="pricing", on_delete=models.CASCADE
    )
    price = models.DecimalField(
        max_digits=10, decimal_places=2, validators=[MinValueValidator(0.01)]
    )
...
class SEO(models.Model):
    product = models.OneToOneField(
        Products, related_name="seo", on_delete=models.CASCADE
    )
...
class ShippingInfo(models.Model):
    product = models.OneToOneField(
        Products, related_name="shipping_info", on_delete=models.CASCADE
    )
